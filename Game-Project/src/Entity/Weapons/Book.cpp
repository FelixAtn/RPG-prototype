...
// 		m_AbilitySprite[i].setPosition(m_Player.GetPlayer().getGlobalBounds().getPosition());
// 		std::cout << m_Player.GetPlayer().getPosition().x;
...
// 			m_AbilitySprite[i].setPosition(m_AbilitySprite[i].getPosition() + m_Direction * 15.f);
// 
//  			if (m_AbilitySprite[i].getPosition().x >= windowMax.x ||
//  				m_AbilitySprite[i].getPosition().y >= windowMax.y ||
//  				m_AbilitySprite[i].getPosition().x <= 0 ||
//  				m_AbilitySprite[i].getPosition().y <= 0 ||
// 				m_AbilitySprite.size() == 2)
// 			{
...
// void Book::Init()
// {
// 	m_Loader.Load(m_AbyssalBookText, "Energy Ball/EnergyBall.png");
// 	m_FireBall.setTexture(m_AbyssalBookText);
// 	m_FireBall.setTextureRect(sf::IntRect(0, 0, 0, 0));
// }
