...
Characters::Characters(std::vector<sf::Sprite*> sprite)
{
	...
	m_FoeText.loadFromFile("C:/Users/Felix/Desktop/Game-Project/Assets/mobss.png");
// 	sprite.push_back(m_World);
// 	sprite.push_back(m_Player);
// 	sprite.push_back(m_Foe);
}
