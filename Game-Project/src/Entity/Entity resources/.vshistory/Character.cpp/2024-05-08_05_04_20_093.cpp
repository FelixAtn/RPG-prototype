...
//Characters::Characters() : m_Player(m_Player), m_Friend(m_Friend), m_Foe(m_Foe), m_World(m_World), m_Globe(m_Globe) {}

Characters::Characters()
{
	this->m_Player = new sf::Sprite;
	this->m_PlayerText = new sf::Texture;
}
