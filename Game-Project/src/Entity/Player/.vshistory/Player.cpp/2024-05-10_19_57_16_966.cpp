...
Player::Player(Window& window, InputManager& m_Input) : m_Input(m_Input), m_Window(window), m_DeltaTime(m_DeltaTime),Character(m_PlayerText, m_Player)
{
	Init();
}
Player::~Player()
