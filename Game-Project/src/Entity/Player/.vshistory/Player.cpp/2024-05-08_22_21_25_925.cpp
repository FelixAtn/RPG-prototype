...
PlayerEntity::PlayerEntity(Window& window, InputManager& m_Input, Characters& m_Character) : m_Input(m_Input), m_Window(window), Characters(vec, texture), m_Character(m_Character)
{
	
// 	if(texture->loadFromFile("C:/Users/Felix/Desktop/Game-Project/Assets/mobss.png"))
// 	{
// 		std::cout << "hi";
// 	}
...
// 	spr->setTextureRect(sf::IntRect(0, 0, 80, 80));
